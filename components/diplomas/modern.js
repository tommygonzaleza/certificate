                        ...
                        <View style={styles.printSecondRowColumnCenter}>
                            <RecognizesThat>
                                <Text style={styles.recognizes} >
                                    {strings["Recognizes that"].toUpperCase()}
                                </Text>
                            </RecognizesThat>
                            {
                                (student
                            ...
                            <SuccesComplete>
                                <Text>
                                    {strings["Has Successfully Completed"].toUpperCase()}
                                </Text>
                            </SuccesComplete>
                            <FullStackDevProgram>
                                <Text>
                                    {strings["The Full Stack Development Program"].toUpperCase()}
                                </Text>
                            </FullStackDevProgram>
                            <Hours>
                                <Text>
                                    {specialty.duration_in_hours} {strings["Hours"].toUpperCase()}
                                </Text>
                            </Hours>
                            <NameOfCohort>
                                <Text>
